...
const New = () => {
  ...
  useEffect(() => {
    ...
    fetchNewProducts(skip, ITEMS_PER_PAGE).then((data) => {
  ...
  return (
    <section className="page">
      <div className="container page__header">
        ...
        <p className="page__subtitle">Свежие поступления в нашем магазине</p>
      </div>
      <ProductGrid products={products} emptyMessage="Новинок пока нет" />
      {totalPages > 1 && (
